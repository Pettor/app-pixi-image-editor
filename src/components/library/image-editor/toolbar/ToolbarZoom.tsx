...
export function ToolbarZoom(): ReactElement {
  ...
  return (
    <div className="absolute bottom-0 left-0 z-10 flex justify-center p-4">
      <div className="glass navbar h-10 min-h-0 w-auto gap-4 rounded-box border border-neutral-content bg-base-100 bg-opacity-60 shadow-xl dark:bg-neutral dark:bg-opacity-80 dark:bg-none md:h-12">
