import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{$t as t,D as n,E as r,Ht as i,Qt as a,St as o,Ut as s,a as c,c as l,o as u,s as d,xt as f}from"./CanvasPool-BTy8H5_N.js";import{B as p,V as m,X as h,Z as g}from"./RenderTargetSystem-g5C0GOfC.js";var _,v,y;function b(){return(b=e((()=>{_={name:`local-uniform-bit`,vertex:{header:`
...
`);return Function(`uv`,`data`,`dataInt32`,`offset`,a)}function P(){return(P=e((()=>{M()})))()}function F(e,t){return`
    ...
    `}var I,L;function R(){return(R=e((()=>{I={f32:`
        ...
        data[offset + 2] = v[2];
        data[offset + 3] = v[3];
    `}})))()}var z;function B(){return(B=e((()=>{t(),i(),z=class extends a{constructor({buffer:e,offset:t,size:n}){super(),this.uid=s(`buffer`),this._resourceType=`bufferResource`,this._resourceId=s(`resource`),this._bufferResource=!0,this.destroyed=!1,this.buffer=e,this.offset=t|0,this.size=n,this.buffer.on(`change`,this.onBufferChange,this)}get _gcLastUsed(){return this.buffer?._gcLastUsed??-1}set _gcLastUsed(e){this.buffer&&(this.buffer._gcLastUsed=e)}onBufferChange(){this._resourceId=s(`resource`),this.emit(`change`,this)}destroy(e=!1){this.destroyed=!0,e&&this.buffer.destroy(),this.emit(`change`,this),this.buffer=null,this.removeAllListeners()}}})))()}export{v as S,x as _,L as a,_ as b,M as c,A as d,D as f,C as g,E as h,I as i,j as l,w as m,B as n,N as o,O as p,R as r,P as s,z as t,k as u,S as v,y as x,b as y};